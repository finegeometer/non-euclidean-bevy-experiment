...
fn setup(
    ...
    for x in 0..3 {
        for y in 0..3 {
            for z in 0..3 {
                let transform = Transform::from_xyz(0.2 * x as f32, 0.2 * y as f32, 0.2 * z as f32);
    ...
    commands.spawn_bundle(LightBundle {
        transform: Transform::from_xyz(0.25, 0.25, 0.75),
        light: Light {
            intensity: 0.5,
            ..Default::default()
        },
    ...
    commands
        .spawn_bundle(PerspectiveCameraBundle {
            transform: Transform::from_xyz(0.25, 0.5, 0.5).looking_at(Vec3::ZERO, Vec3::Y),
